...
public class Utils {
    ...
    public static String checkHasParas(String url, List<NameValuePair> nvps, String encoding) throws UnsupportedEncodingException {
      ...
      *
      * @Author: Frame
      * @Data:   2016/7/19 16:59
      * @Param:
      *
      */
    public static HttpEntity map2json(Map<String, Object> map, String encoding){
      ...
      *
      * @Author: Frame
      * @Data:   2016/7/27 17:26
      * @Param:  
      * 
      */
    public static HttpEntity map2json(JSONObject json, String encoding){
