...
public class HttpHeader {
    ...
    public HttpHeader keepAlive(String keepAlive) {
      ...
      *
      * @Author: Frame
      * @Data:   2016/7/27 17:42
      * @Param:  
      * 
      */
     public HttpHeader s(String s) {
         headerMaps.put(HttpReqHead.s,
                 new BasicHeader(HttpReqHead.s, s));
         return this;
     }
     /**
      * 自定义sessionID
      *
      * @Author: Frame
      * @Data:   2016/7/27 17:46
      * @Param:  
      * 
      */
    public HttpHeader sessionID(String sessionID) {
        headerMaps.put(HttpReqHead.sessionID,
                new BasicHeader(HttpReqHead.sessionID, sessionID));
        return this;
    }
    ...
    public String s(){
        return get(HttpReqHead.s);
    }

    public String sessionID(){
        return get(HttpReqHead.sessionID);
    }
